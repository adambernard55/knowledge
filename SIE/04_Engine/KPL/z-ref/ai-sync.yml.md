      ...
      - name: Sync to Knowledge Base
        ...
        run: |
          ...
          for file in "${files[@]}"; do
            ...
            case "$file" in
              *"/0_fundamentals/"*) TOPIC_ID=1186 ;;
              *"/1_models/"*) TOPIC_ID=1187 ;;
              *"/2_agents/"*) TOPIC_ID=1188 ;;
              *"/3_methods/"*) TOPIC_ID=1189 ;;
              *"/4_applications/"*) TOPIC_ID=1190 ;;
              *"/5_ethics-and-governance/"*) TOPIC_ID=1191 ;;
              *"/6_future-trends/"*) TOPIC_ID=1192 ;;
            esac
