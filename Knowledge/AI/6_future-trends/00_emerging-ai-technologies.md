...
See also: [Architectures and LLMs](../3_methods/01_architectures-and-llms.md) and [Top LLMs](../1_models/4_comparisons/01_top-10-llms.md).
...
See: [Embeddings and Vectorization](../3_methods/02_embeddings-and-vectorization.md) and [Specific Models](../1_models/1_specific-models/1_specific-models.md).
...
- [AI Agents Index](../2_agents/index.md)
...
See: [Multimodal AI](../3_methods/07_multimodal-ai.md).
...
See: [Top 10 Local LLMs](../1_models/4_comparisons/02_top-10-local-llms.md).
...
See: [Evaluation and Performance](../3_methods/08_evaluation-and-performance.md) and [LLM-Evalkit](../1_models/3_evaluation-and-tooling/LLM-Evalkit.md).
...
- [Responsible AI Principles](../5_ethics-and-governance/00_responsible-ai-principles.md)  
...
- Models and Methods  
  - [Architectures and LLMs](../3_methods/01_architectures-and-llms.md)  
  - [Training and Finetuning](../3_methods/03_training-and-finetuning.md)  
  - [Agentic AI Overview](../3_methods/06_agentic-ai-overview.md)  
