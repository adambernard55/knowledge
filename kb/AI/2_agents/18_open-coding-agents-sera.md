---
title: "Open Coding Agents (SERA): An Accessible Framework for Specializing Code Agents"
id: kb/AI/agents/open-coding-agents
version: "1.0"
steward: Adam Bernard
updated: 2026-01-28
status: Active
doc_type: Reference
summary: Provides a comprehensive overview of the Open Coding Agents framework and its SERA model family, detailing a cost-effective method for fine-tuning agents on private codebases.
tags:
  - ai
  - agents
  - coding-agent
  ...
  - fine-tuning
relations:
  - "kb/AI/2_agents/toolkits/10_claude-code-beyond-basics.md"
  - "kb/AI/2_agents/14_building-your-first-personal-ai-agent.md"
aliases:
  - SERA
  - Soft-verified Efficient Repository Agents
  - Open Coding Agents
security_level: Public
semantic_summary: "This document introduces Open Coding Agents and the SERA model family, an open-source framework designed for creating and fine-tuning coding agents on custom repositories. It details the 'Soft-verified generation' (SVG) method, which significantly reduces training costs, and presents benchmarks showing SERA's competitive performance against models like Devstral Small 2. The guide also covers its compatibility with Claude Code and optimizations for NVIDIA hardware."
synthetic_questions:
  - "What are Open Coding Agents and SERA?"
  - "How does the SERA framework reduce the cost of training coding agents?"
  - "Can SERA models be fine-tuned on a private codebase?"
  - "How does SERA's performance compare to other coding agents like Devstral?"
key_concepts:
  - Open Coding Agents
  - SERA
  ...
  - Fine-Tuning
  - SWE-Bench
primary_keyword: "open coding agents"
seo_title: "Open Coding Agents: A Guide to the SERA Framework"
meta_description: "Learn about Open Coding Agents and the SERA framework, a cost-effective, open-source method for building and fine-tuning coding agents on any codebase."
excerpt: "Discover Open Coding Agents and SERA, a new framework that makes it accessible for any team to build powerful, specialized coding agents for their own repositories."
---
