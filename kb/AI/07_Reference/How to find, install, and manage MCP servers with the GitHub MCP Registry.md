---
title: "Reference: GitHub MCP Registry"
id: 20251029095512
version: 2
Author: Adam Bernard
steward:
...
category: AI
category_id:
Excerpt: A technical guide on using the GitHub MCP Registry to discover, install, publish, and manage Model Context Protocol (MCP) servers for AI development.
Meta Description: Technical reference for developers and administrators on finding, installing, publishing, and governing MCP servers using the GitHub MCP Registry and CLI.
