...
1. **AI Literacy**
   - Understand what AI can and cannot do (see: [What Is AI](00_what-is-ai.md)).  
...
2. **Prompting and Task Decomposition**
   ...
   - Break complex tasks into steps (see: [Prompt Engineering Basics](04_prompt-engineering-basics.md) and [Prompt Frameworks](05_prompt-frameworks.md)).  
...
5. **Collaboration with Agents and Copilots**
   ...
   - Provide feedback to improve behavior over time (see: [Human–AI Collaboration](05_human-ai-collaboration.md)).
...
This aligns with the **human-in-the-loop** patterns in [Human–AI Collaboration](05_human-ai-collaboration.md).
...
- Identify a **low-risk workflow** to test with an agent (see: [AI Agents Running Workflows](01_ai-agents-running-workflows.md)).  
...
- **Principles:**  
  - Adopt and socialize [Responsible AI Principles](00_responsible-ai-principles.md.md).
...
- **Privacy & Compliance**  
  ...
  - See: [Data Privacy and Compliance](01_data-privacy-and-compliance.md).

- **Bias & Fairness**  
  - Unequal outcomes in targeting, recommendations, or triage.  
  - See: [Bias and Fairness](02_bias-and-fairness.md).

- **Transparency & Accountability**  
  - Users and regulators needing to know when AI is used and who is responsible.  
  - See: [Transparency and Accountability](03_transparency-and-accountability.md).

- **IP & Confidentiality**  
  - Training on proprietary data, using generative outputs commercially.  
  - See: [Intellectual Property](04_intellectual-property.md).
...
1. Learn the basics (fundamentals and methods):  
   ...
   - [Prompt Engineering Basics](04_prompt-engineering-basics.md)
...
1. Create or refine a **Responsible AI policy**:
   - Use [Responsible AI Principles](00_responsible-ai-principles.md.md) as a base.
