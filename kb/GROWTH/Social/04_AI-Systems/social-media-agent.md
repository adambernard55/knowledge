---
title: "Social Media Agent - Building with Nebius, Composio & Memori"
id: "KB/AI/MKTG/SM-15"
version: "1.0"
...
status: "Active"
doc_type: "Reference"
summary: "Technical guide to building an AI social media agent that learns your writing style and posts tweets autonomously using Nebius, Composio, ScrapeGraph, and Memori."
tags:
  - "social-media"
  - "ai"
  - "ai-agent"
...
relations:
  - "00_Social-Media.md"
  - "ai-for-social-media-marketing.md"
aliases:
  - "Twitter AI Agent"
  - "Social Media Bot Builder"

# --- AI & RAG Enhancement ---
semantic_summary: "This document is a step-by-step technical guide to building an AI-powered social media agent using Nebius AI for language models, ScrapeGraph for tweet scraping, Memori for persistent style memory, and Composio for Twitter API integration. The agent learns a user's writing style from their viral tweets and generates on-brand content autonomously. It targets developers and technical marketers building social media automation systems."
synthetic_questions:
  - "How do I build an AI agent that posts tweets in my writing style?"
  - "What tech stack is needed for a social media AI agent with persistent memory?"
  - "How does Memori provide persistent style memory for AI social media agents?"
key_concepts:
...
# --- SEO & Publication ---
primary_keyword: "AI social media agent"
seo_title: "Build an AI Social Media Agent with Nebius, Composio & Memori"
meta_description: "Build an AI social media agent that learns your style and posts tweets using Nebius, Composio, and Memori."
excerpt: "A technical guide to building an AI social media agent that scrapes your viral tweets, learns your writing style with persistent memory, and posts autonomously via Composio and Nebius AI."
cover_image: ""
---
